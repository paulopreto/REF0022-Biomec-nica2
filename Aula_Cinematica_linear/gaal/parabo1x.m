function parabo1x(a,b,c,P,X0)
%parabo1x(a,b,c) desenha o parabolóide elíptico
%                  ax=y^2/b^2+z^2/c^2
%parabo1x(a,b,c,P) desenha o parabolóide elíptico 
%                  ax1=y1^2/b^2+z1^2/c^2
%                  em que [x;y;z]=P*[x1;y1;z1]
%parabo1x(a,b,c,P,X0) desenha o parabolóide elíptico 
...
%parabo1x(sqrt(5),sqrt(3),sqrt(6),P)
...
if nargin >= 3
 ...
 yy=b*t'*cos(s);
 zz=c*t'*sin(s);
 xx=sign(a)*t'.^2*ones(1,npts);
 x=xx;y=yy;z=zz;
end 
if nargin >= 4
 PP=P;P=double(P);
 if simplify(det(PP)) ~= 1
