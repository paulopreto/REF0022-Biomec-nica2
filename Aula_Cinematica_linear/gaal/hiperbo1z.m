function hiperbo1z(a,b,c,P,X0)
%hiperbo1z(a,b,c) desenha o hiperbolóide de uma folha 
%                  x^2/a^2+y^2/b^2-z^2/c^2=1
%hiperbo1z(a,b,c,P) desenha o hiperbolóide de uma folha 
%                  x1^2/a^2+y1^2/b^2-z1^2/c^2=1
%                  em que [x;y;z]=P*[x1;y1;z1]
%hiperbo1z(a,b,c,P,X0) desenha o hiperbolóide de uma folha 
...
%hiperbo1z(sqrt(5),sqrt(3),sqrt(6),P)
