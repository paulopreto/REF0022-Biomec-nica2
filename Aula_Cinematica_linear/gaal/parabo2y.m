function parabo2y(a,b,c,P,X0)
%parabo2y(a,b,c) desenha o parabolóide elíptico
%                  by=x^2/a^2-z^2/c^2
%parabo2y(a,b,c,P) desenha o parabolóide elíptico 
%                  by1=x1^2/a^2-z1^2/c^2
%                  em que [x;y;z]=P*[x1;y1;z1]
%parabo2y(a,b,c,P,X0) desenha o parabolóide elíptico 
%                  by2=x2^2/a^2-z2^2/c^2
...
%parabo2y(sqrt(5),sqrt(3),sqrt(6),P)
