function parabo1y(a,b,c,P,X0)
%parabo1y(a,b,c) desenha o parabolóide elíptico
%                  by=x^2/a^2+z^2/c^2
%parabo1y(a,b,c,P) desenha o parabolóide elíptico 
%                  by1=x1^2/a^2+z1^2/c^2
%                  em que [x;y;z]=P*[x1;y1;z1]
%parabo1y(a,b,c,P,X0) desenha o parabolóide elíptico 
...
%parabo1y(sqrt(5),sqrt(3),sqrt(6),P)
